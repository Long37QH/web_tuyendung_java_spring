...
<head>
    ...
    <script>
        ...
        $(document).ready(() => {
            const avatarFilelogo = $("#avatarFilelogo");
            const orgImage = "${userTD.logoCompany}";
            if (orgImage) {
                const urlImage = "/images/company/" + orgImage;
                $("#avatarPreviewlogo").attr("src", urlImage);
                $("#avatarPreviewlogo").css({ "display": "block" });
            }
            avatarFilelogo.change(function (e) {
                const imgURL = URL.createObjectURL(e.target.files[0]);
                $("#avatarPreviewlogo").attr("src", imgURL);
                $("#avatarPreviewlogo").css({ "display": "block" });
            });
        });
    </script>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form:form class="row g-3" method="post"
                                enctype="multipart/form-data" action="/update_profileTD"
