                    ...
                    <div class="card-body">
                      ...
                      action="/admin/user/creat" modelAttribute="usernew">
                        ...
                        <div class="col-md-6">
                          ...
                          <form:input type="email" class="form-control" id="inputEmail5" path="email"/>
                        </div>
                        <div class="col-md-6">
                          <label for="inputPassword5" class="form-label">Password: </label>
                          <form:input type="password" class="form-control" id="inputPassword5" path="password"/>
                        </div>
                        <div class="col-6">
                          <label for="inputAddress5" class="form-label">Địa chỉ : </label>
                          <form:input type="text" class="form-control" id="inputAddres5s" placeholder="Thành phố Vinh..." path="addRess"/>
                        </div>
                        <div class="col-6">
                          <label for="inputAddress2" class="form-label">Số điện thoại : </label>
                          <form:input type="text" class="form-control" id="inputAddress2" placeholder="+84" path="phone"/>
                        </div>
                        <div class="col-3">
                          <label for="inputAddress2" class="form-label">Năm sinh : </label>
                          <form:input type="text" class="form-control" id="inputAddress2" placeholder="dd/mm/yyyy" path="dateOfBirth"/>
                        </div>
                        <div class="col-md-3">
