                        ...
                        <div class="card-body">
                          ...
                          <form:form class="row g-3" method="post" enctype="multipart/form-data"
                            ...
                            <div class="col-md-12">
                              ...
                              <form:input type="text" class="form-control ${not empty errorFullname ? 'is-invalid' : ''}" id="fullName" path="fullName" />
                              ${errorFullname}
                            </div>
                            <div class="col-md-6">
                              <label for="inputEmail5" class="form-label">Email:</label>
                              <form:input type="email" class="form-control ${not empty errorEmail ? 'is-invalid' : '' } " id="inputEmail5" path="email" />
                              ${errorEmail}
                            </div>
                            <div class="col-md-6">
                              <label for="inputPassword5" class="form-label">Password: </label>
                              <form:input type="password" class="form-control ${not empty errorPass ? 'is-invalid' : ''}" id="inputPassword5" path="password" />
                              ${errorPass}
                            </div>
                            <div class="col-6">
                              <label for="inputAddress5" class="form-label">Địa chỉ : </label>
                              <form:input type="text" class="form-control" id="inputAddres5s"
                                placeholder="Thành phố Vinh..." path="addRess" />
                            </div>
                            <div class="col-6">
                              <label for="inputAddress2" class="form-label">Số điện thoại : </label>
                              <form:input type="text" class="form-control" id="inputAddress2" placeholder="+84"
                                path="phone" />
                            </div>
                            <div class="col-3">
                              <label for="inputAddress2" class="form-label">Năm sinh : </label>
                              <form:input type="text" class="form-control" id="inputAddress2" placeholder="dd/mm/yyyy"
                                path="dateOfBirth" />
                            </div>
                            <div class="col-md-3">
