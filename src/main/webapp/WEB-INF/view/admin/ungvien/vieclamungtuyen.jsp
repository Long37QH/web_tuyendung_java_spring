    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="/admin/ungvien">Quản lý ứng viên</a></li>
          <li class="breadcrumb-item active">Việc làm ứng tuyển</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
          ...
          <div class="row">
            ...
            <div class="col-lg-12" >
                <div class="d-flex justify-content-between mb-2 mt-2">
                    <h5 class="mb-3">Danh sách việc làm ứng tuyển</h5>
                    ...
                    <tbody>
                        <c:forEach var="apply" items="${listApplies}" varStatus="status">
                            <tr>
                                ...
                                <td style="width: 200px;" >${apply.job.title}</td>
                                <td>${apply.job.workingForm}</td>
                                <td>${apply.job.salary}</td>
                                <td class="${apply.status == 'Đã duyệt' ? 'text-success' : 'text-warning'}" ><strong>${apply.status}</strong></td>
                                <td>${apply.job.dateline}</td>
