          ...
          <div class="row">
            ...
            <div class="col-lg-12" >
                <div class="d-flex justify-content-between mb-2 mt-2">
                    <h5 class="mb-3">Danh sách nhà tuyển dụng</h5>
                    ...
                    <tbody>
                        <c:forEach var="user" items="${listUser}" varStatus="status">
                            <tr>
                                ...
                                <td style="width: 290px;" >${user.company}</td>
                                <td style="width: 150px;">
                                    <img src="/images/company/${user.logoCompany}" class="mx-auto" alt="" style="width: 150px;">
                                </td>
                                <td>${user.plan.name}</td>
                                <td>
                                    <a class="btn btn-success"
                                        href="/admin/tuyendung/${user.id}"><i class="fa-regular fa-eye"></i> Xem chi tiết</a>
